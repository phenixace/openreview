...
玩家要在 4 年、每年 5 轮的学术赛季中拿到至少 3 篇顶会录用。会议按 ICML、NeurIPS、ICLR、ACL、AAAI 循环；每轮包含月度技能进修、随机事件、论文生产、arXiv / bid 决策、同行评审和一个约 30% 录用率但不严格按分数排序的会议决议。达到毕业线后，还可以开启额外 5 年、共 25 轮的海优挑战。
